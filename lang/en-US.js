...
const en_US = {
  ...
  confirmResetMessage: "This will clear all lyric time markers (including per-char/word markers). Continue? This cannot be undone.",
  ...
  char_options: "Char Processing Options",
  skip_space: "Auto Skip Spaces",
  word_mode: "Word-by-Word Mode",
  ...
  mark_settings: "Mark Settings",
  bind_time_on_back: "Seek audio on back",
  ...
  prev_lyric_text_char: "PREV CHAR:",
  current_lyric_text_char: "CURRENT:",
  next_lyric_text_char: "REMAINING:",
  none: "None",
  uninitialized_time: "[--:--.--]",
  back_2s: "Back 2s",
  ...
  key_prev_char: "Moved back to previous char (mark undone)",
  key_next_char: "Advanced to next char",
